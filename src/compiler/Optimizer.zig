...
pub fn constantFolding(self: *Optimizer) void {
    self.traverseBlock(self.fir.entry);
}

fn traverseBlock(self: *Optimizer, start_idx: usize) void {
...
fn traverseStmt(self: *Optimizer, node_idx: usize) void {
...
fn traverseExpr(self: *Optimizer, expr_idx: usize) usize {
