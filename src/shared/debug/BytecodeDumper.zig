    ...
    while (self.ip < self.code.len) {
        ...
        switch (op) {
            ...
            .set_global_array, .set_local_array => {
                ...
                const instr = if (op == .set_global_array) "OP_SET_GLOBAL_ARRAY" else "OP_SET_LOCAL_ARRAY";
                self.printInstruction(instr, "{d: <10}x{d}", .{ var_index, index_amount });
            },
            ...
            .lower_i => self.printInstruction("OP_LOWER_I", "", .{}),
            .lower_equal_i => self.printInstruction("OP_LOWER_EQUAL_I", "", .{}),
            .greater_i => self.printInstruction("OP_GREATER_I", "", .{}),
            .greater_equal_i => self.printInstruction("OP_GREATER_EQUAL_I", "", .{}),
            .lower_f => self.printInstruction("OP_LOWER_F", "", .{}),
            .lower_equal_f => self.printInstruction("OP_LOWER_EQUAL_F", "", .{}),
            .greater_f => self.printInstruction("OP_GREATER_F", "", .{}),
            .greater_equal_f => self.printInstruction("OP_GREATER_EQUAL_F", "", .{}),
            ...
            .eof => self.printInstruction("OP_EOF", "", .{}),
        }
    }
}
